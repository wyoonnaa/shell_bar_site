...
SECRET_KEY = 'django-insecure-xck5t96996w&c6-=y+9*8v0419-!i=@0*#^)ir3&!&u^#c+!dd'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'my_site/templates/my_site/static'),
]


# Путь для загруженных файлов (если они будут)
MEDIA_URL = '/media/'
